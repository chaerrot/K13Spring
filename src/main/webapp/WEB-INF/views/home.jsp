...
<body>
	...
	<!-- 
		...
		resources 폴더를 제공한다. 해당 폴더이 매핑은 servlet-context.xml에서
		변경하거나 추가할 수 있다.
	 -->
	<h3>resources 폴더 사용하기</h3>
	<!-- views 폴더 하위에 있는 해당 이미지는 출력되지 않는다. views
	...
	<!-- 
		...
		별칭을 부여하여 매필할 수 있다.
	 -->
	<img src="./resources/images/img_avatar2.png" alt="아바타2" width="200px" />
	<img src="./static/images/1.png" alt="스펀지밥" width="200px" />
	
	
	<!-- 1. 컨트롤러 제작을 위해 제일 먼저 요청명을 결정한다. -->
	<h2>첫 번째 컨트롤러 만들기</h2>
	<li>
	<a href="./home/helloSpring" target="_blank">첫 번째 컨트롤러</a></li>
	
	<!-- 컨트롤러: FormControlller.java -->
	<h3>form값 처리하기</h3>
	<li>
	...
	<h3>@Cotroller, @Service, @Repository 어노테이션</h3>
	...
	resources 폴더 하위에서만 사용할 수 있다.
	 -->
	<li>
		<a href="./notFound.html" target="blank">html 파일 사용X</a>
		&nbsp;&nbsp;&nbsp;
	...
	<!-- 
		webapp 하위에서는 JSP파일은 사용할 수 있다. jsp이므로 스크립트렛이나
		클래스 임포트 등도 모두 가능하다.
	 -->
	<li>
		<a href="./randomNum.jsp" target="blank">jsp 파일 사용하기</a>
	</li>
	<li>
		<a href="./htmlJspUsed/includeUse.do" target="blank">
			요청명 방식에서 파일 인클루드하기
		</a>
	</li>
