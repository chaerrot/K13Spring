...
/*
 ...
 차후 supports(), validate() 두 개의 메서드를 오버라이딩해야 한다.
 */
public class MemberValidator implements Validator {
	
	/*
	 매개변수로 전달된 객체가 유효성 검증을 지원할 수 있는 커맨드 객체인지
	...
	public void validate(Object obj, Errors errors) {
		...
		if (member_id==null || member_id.trim().isEmpty()) {
			System.out.println("아이디가 null입니다ㅜㅜ");
			// 검증에 실패한 경우 해당 메서드를 통해 검증 결과를 반환한다.
