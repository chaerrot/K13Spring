...
public class RequestMappingController {
	// get 방식 혹은 post 방식의 전송을 위한 인덱스 페이지 매핑
	...
	/*
	 ...
	 전송 방식까지 명시해야할 경우에는 속성을 제거하면 에러가 발생한다.
	 */
	...
	public String getSearch(HttpServletRequest req, Model model) {
		/*
		 ...
		 내장 객체가 있다면 매개변수 형태로 선언하여 즉시 사용할 수 있다.
		 즉, 컨트롤러에 정의되는 메서드는 매개변수의 개수가 큰 의미를 가지지
		 않는다.
		 */
	...
	/*
	 ModelAndView객체
	 	...
	 	- model 객체에 데이터 저장: 참조변수.addObject("속성명", "속성값")
