...
public class DIController {
	...
	public ModelAndView mydi2(Model model) {
		...
		// XML 설정 파일을 기반으로 생성한 컨텍스트를 통해 빈을 주입 받는다.
	...
	public ModelAndView mydi3(Model model) {
		...
		// 어노테이션을 통해 생성된 빈을 주입 받기 위한 컨텍스트 선언
